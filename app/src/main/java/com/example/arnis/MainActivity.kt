...
class MainActivity : AppCompatActivity() {
    ...
    private fun captureVideo() {
        // check if VideoCapture has been created; if not do nothing
        val videoCapture = this.videoCapture ?: return

        // disable UI until request action is completed by CameraX
        viewBinding.videoCaptureButton.isEnabled = false

        // if recording is in progress, stop and release it
        ...
        val contentValues = ContentValues().apply {
            ...
            if (Build.VERSION.SDK_INT > Build.VERSION_CODES.P) {
                put(MediaStore.Video.Media.RELATIVE_PATH, "Movies/Arnis-Video")
            }
        }
    ...
    private fun startCamera() {
        ...
        cameraProviderFuture.addListener({
            try {
                ...
                val videoAnalysisUseCase = buildVideoAnalysisUseCase()
                ...
                cameraProvider.bindToLifecycle(
                    this, cameraSelector, preview, videoCapture, videoAnalysisUseCase)
            } catch (exc: Exception) {
    ...
    private fun buildVideoAnalysisUseCase(): ImageAnalysis {
